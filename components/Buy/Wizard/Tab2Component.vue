<template>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <label class="vis-label">Cidade <i class="fal fa-globe-asia"></i></label>
                                                                        <input type="text" placeholder="Your city" value=""/>                                                  
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <label class="vis-label">Pais </label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-12">
                                                                        <label class="vis-label">Rua <i class="fal fa-road"></i> </label>
                                                                        <input type="text" placeholder="Your Street" value=""/>                                                  
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-8">
                                                                        <label class="vis-label">Estado<i class="fal fa-street-view"></i></label>
                                                                ...
                                                                <a  href="#"  class="previous-form action-button back-form   color2-bg">Voltar</a>
                                                                <a  href="#"  class="next-form   action-button color-bg">Pagamento</a>
                                                            </fieldset>
</template>